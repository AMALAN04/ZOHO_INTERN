...
public class Update {
	...
	public static boolean updateProfile(String tableName, String column, String value, String id) {//update student and instructor details
		String query;
	...
	public static void updateNoOfCourse(String id) {   //update no of course offered by instructor
	...
	public static boolean favouriteCourse(String sId, String cId, int fav) {//Add courses to favourites
	...
	public static boolean addReview(Review review) { // add to review
